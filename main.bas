...
620 a$="                         "
630 a$=a$+"if you want to play a new game, please rewind "
640 a$=a$+"tape to '000' and then press f1.   "
650 a$=a$+"press f3 to quit the game.   "
...
770 el=8:poke888,0:gosub1240:sys(ml+00)
780 print"    press play on tape{down}              and then fire!"
